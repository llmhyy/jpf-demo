...
public class SimulateJPFTest {
	public static void main(String[] args) {
		String targetClass = "example.HelloWorld";//"org.apache.commons.math.stat.descriptive.DescriptiveStatistics";
		String method = "example.HelloWorld.main(sym)";//"org.apache.commons.math.stat.descriptive.DescriptiveStatistics.addValue(sym)";
...
//		new Test().runJPF(new String[]{"+app=src/main/addValue.jpf"});
	...
	private static void testCoverage() {
		...
		String targetClass = "example.TestExample";//"org.apache.commons.math.stat.descriptive.DescriptiveStatistics";
		String method = "example.TestExample.main(sym)";//"org.apache.commons.math.stat.descriptive.DescriptiveStatistics.addValue(sym)";
		String classPath = "bin";
		String[] appArgs = {
				"+classpath="+classPath,
				"+target="+targetClass,
